...
<head>
    ...
    <title>Calculs sur des tableaux multidimensionnels ( Matrices) </title>
</head>
<body>
    <div class="container">
        ...
        <main>
            ...
            <section class="objectif">
                <h2 class="objectif_title">Objéctif :</h2>
                <h3 class="objectif_goal">Manipuler les tableaux multidimensionnels.</h3>
                <h3 class="objectif_goal">Effectuer des claculs matricielle.</h3>
            </section>
