...
<head>
    ...
    <title>Afficher et formater les chaines de caractères</title>
</head>
<body>
    <div class="container">
        ...
        <main>
            ...
            <section class="objectif">
                ...
                <h3 class="objectif_goal">Utiliser les fonctions d'affichage et de formatage des chaines de caractères.</h3>
            </section>
