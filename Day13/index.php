...
<body>
    ...
    <nav>
        <ul>
            <li><a href="exercices.php">Les exercies</a></li>
        </ul>
    </nav>
    ...
    <section class="target">
        <h2>Exercices coming from <a href="https://www.codingame.com/playgrounds/32339/exercices-de-php-pour-debutant">coding game</a></h2>
    </section>
    <footer>
        <p>© 2023 akkabb, Inc.</p>
    </footer>
