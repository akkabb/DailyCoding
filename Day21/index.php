...
<body>
    <div class="container">
        ...
        <nav>
            <ul>
                <li><a href="playCode.php">Les exercies</a></li>
            </ul>
        </nav>
        ...
        <section class="target">
            <h2>Exercices coming from <a href="https://waytolearnx.com/2020/04/exercice-php-corrige-partie-1.html?utm_content=cmp-true">waytolearnx.com</a></h2>
        </section>
        <footer>
            <p>© 2023 akkabb, Inc.</p>
        </footer>
